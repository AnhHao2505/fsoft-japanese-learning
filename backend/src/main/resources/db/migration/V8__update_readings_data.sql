...
UPDATE readings 
SET passage = '妻は掃除をしない。自分ではハウスダスト・アレルギーだからだという。ほこりを吸うと咳がでるし、ほこりに触れると肌がかゆくなるという。（　　1　　）、掃除機も使えない。（　　2　　）、私が毎週休みの日に家の掃除をすることになる。私だってあんまりほこりがたまっていたら気になるから、しかたがないと思ってやっているんだ。（　　3　　）、妻はアレルギー体質と診断されたことは一度もない。', 
    passage_translation = '', 
    notes = '', 
    difficult_kanji = '' 
WHERE id = 4;
...
UPDATE readings 
SET passage = '人間が涙を流すのは、悲しいときだけではない。私たちは自然に目を閉じたり開いたりしている。それを「まばたき」と言う。そのまばたきをするたびに、涙が目の表面を流れているのだ。\nしかし、最近の調査によると、パソコンを長い時間使う人は、まばたきの回数が減って、涙の量が減ってしまう人が多いそうだ。そうすると目の表面がかわいて、目の病気になることもある。', 
    passage_translation = '', 
    notes = '', 
    difficult_kanji = '' 
WHERE id = 5;
...
UPDATE readings 
SET passage = '火を使わず、温風も出さずに部屋を暖める話題の遠赤外線ヒーター。中でも最新型の「アッタメール」は、ほかの製品より暖かく、消費電力500Wと省エネ。室内に温度差ができないように暖めるので、顔だけ暖かく足元が寒いというようなことはありません。また空気も汚れません。電気代は9時間使って99円と経済的です。今なら申し込み順に100台までは35,000円とお得です。お早めにどうぞ。「アッタメール」で快適な冬を過ごしませんか。', 
    passage_translation = '', 
    notes = '', 
    difficult_kanji = '' 
WHERE id = 6;
